        ...
        <View style={styles.container}>
          ...
          <View style={[styles.row, styles.header]}>
            <View style={styles.column}>
              <Text style={styles.headText}>Client ID</Text>
            </View>
            <View style={styles.column}>
...
export default function GcList({ navigation }) {
      ...
      <Modal visible={visible} animationType="fade" transparent={true}>
          ...
          >
            ...
            >
              ...
              >
                <Text style={{ fontFamily: "SemiBold" }}>Create GC List</Text>
              ...
              >
                ...
                >
                  ...
                  <SmallInput label={"Company Name"} placeholder={"XYZ Pvt. Ltd."} />
                </View>
                <View
                  style={{
                    flexDirection: "row",
